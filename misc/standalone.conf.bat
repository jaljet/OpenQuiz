...
set "JAVA_OPTS=-Xms2048M -Xmx6512M -XX:MetaspaceSize=96M -XX:MaxMetaspaceSize=256m"
...
set "JAVA_OPTS=%JAVA_OPTS% -XX:+HeapDumpOnOutOfMemoryError  -XX:HeapDumpPath=%JBOSS_HOME%/heapdumps/
